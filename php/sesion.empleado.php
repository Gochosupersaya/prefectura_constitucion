    ...
    <body>
        ...
        <div class="style-options">
            ...
            <div class="style-menu">
                <div class="style-nav">
                    <h4 class="mt-15 mb-10">Posición del menu</h4>
                    <ul>
						<li><a href="../assets/css/sesion/settings/top-nav.css"><i class="fas fa-caret-up"></i> Arriba</a></li>
                        <li><a href="../assets/css/sesion/settings/left-nav.css"><i class="fas fa-caret-left"></i> Izquierda</a></li>
                        <li><a href="../assets/css/sesion/settings/right-nav.css"><i class="fas fa-caret-right"></i> Derecha</a></li>
                        <li><a href="../assets/css/sesion/settings/bottom-nav.css"><i class="fas fa-caret-down"></i> Abajo</a></li>
                    </ul>
                </div>
				<div class="style-back">
                    <h4 class="mt-85 mb-10">Modo de estilo</h4>
                    <ul>
                        <li><a href="../assets/css/sesion/style-dark.css"><i class="fas fa-moon"></i> Oscuro</a></li>
                        <li><a href="../assets/css/sesion/style-light.css"><i class="far fa-lightbulb"></i> Claro</a></li>
                    </ul>
                </div>
				<div class="style-color">
                    <h4 class="mt-55 mb-10">Color del tema</h4>
                    <ul>
		...
		<div id="contact">
			...
			<nav class="header-main" data-simplebar>
				...
				<div class="logo">
          		...
          		<ul>
					<li data-tooltip="homess" data-position="top">
            			<a href="#home" class="icon-h fas fa-house-damage"><br>Solicitar trámite</a>
					</li>
					<li data-tooltip="about" data-position="top">
            			<a href="#about" class="icon-a fas fa-user-tie"><br>Realizar denuncia</a>
					</li>
			...
			<!-- Home Section -->
          	<div class="pt-home" style="background-image: url('../assets/img/prefectura.jpg')">
             	<section>
					...
					<!-- Banner -->
					<div class="banner">
  						<h1>Bienvenida señora secretaria</h1>
